...
<body>
  <div class="container-fluid">
    ...
    <p class="datatable design text-center">Chemicals</p>
    <div class="row">
      <div class="container">
        <div class="btnAdd">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="nameField" class="col-md-3 form-label">Item Name</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="nameField" name="name">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="emailField" class="col-md-3 form-label">Type</label>
              <div class="col-md-9">
            ...
            <div class="mb-3 row">
              <label for="cityField" class="col-md-3 form-label">Expiry Date</label>
              <div class="col-md-9">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            <div class="mb-3 row">
              <label for="addUserField" class="col-md-3 form-label">Item Name</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="addUserField" name="name">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="addEmailField" class="col-md-3 form-label">Type</label>
              <div class="col-md-9">
            ...
            <div class="mb-3 row">
              <label for="addCityField" class="col-md-3 form-label">Expiry Date</label>
              <div class="col-md-9">
